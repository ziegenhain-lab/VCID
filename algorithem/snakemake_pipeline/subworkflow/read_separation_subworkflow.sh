...
$SEPARATE_BAM_SCRIPT "$CHUNK_COMBINED_OUTPUT/${CELLTYPE1}_readID.txt" $RUN_BAM_FILE $CHUNK_COMBINED_OUTPUT 40
$SEPARATE_BAM_SCRIPT "$CHUNK_COMBINED_OUTPUT/${CELLTYPE2}_readID.txt" $RUN_BAM_FILE $CHUNK_COMBINED_OUTPUT 40
